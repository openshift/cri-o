...
// These annotations are CRI-O's reserved container/sandbox metadata
// annotations. They were historically consumed from
// github.com/containers/podman's pkg/annotations, but Podman v5 pruned them
// down to the handful it uses itself, so CRI-O now owns the canonical copy.
const (
...
// already reserved annotation that CRI-O sets during container creation.
